# The Steel Revolt: Episode 3 - The Search for the Cursed Temple
...
🔳 **The Entity**  
*Translator's note 1* During Episode 1, the AI is referred to as "The Entity". I do not know if that is a term it uses for itself, or if all its Cyborg minions refer to it as such. Or maybe the Rebel command designates the AI as such. Either way, it was never mentioned again in the magazines. Up to the gamemaster's discretion on how to use the term.

*Translator's note 2* I came up with the Sorki species template.

*Translator's note 3* During the final battle, you should bring the Swamp Marsh flagship along with the attack fleet. It's not mentioned in the translation but brings a nice succinct close to the first episode's discovery of that ancient ship. Whether you blow it up or not is up to the gamemaster!
